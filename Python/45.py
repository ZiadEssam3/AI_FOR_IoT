...
import pickle
import serial 
# we able to send data throw object : arduinoData
...
while True:
    ...
    for hand in handData:
        # 1- print the gestures to Computer Screen
        for index in keyPoints: # [0,5,6,7,8]
            cv2.circle(flipped_frame,hand[index],10,(0,0,255),2)
        # send it to my out friend Mr Arduino 
        myGesture = myGesture + '\r'
        # send it out 
        arduinoData.write(myGesture.encode()) # create string to play with serial port 
